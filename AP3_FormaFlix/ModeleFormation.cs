...
namespace AP3_FormaFlix
{
    public class ModeleFormation
    {
        ...
        {
            Controleur.VmodeleC.charger("select IDFORMATION, LIBELLE, DESCRIPTION, IDENTIFIANTVIDEO, VISIBILITEPUBLIC, IMAGE from formation;", Controleur.VmodeleC.DT[1]);
        }
        ...
        /// <returns></returns>
        public bool AjoutFormation(string libelle, string description, string video, string image, bool visible)
        {
            try
            {
                // préparation de la requête 
                string requete = "insert into formation values (null, @lib, @descr, @v, @visible, @image)";
